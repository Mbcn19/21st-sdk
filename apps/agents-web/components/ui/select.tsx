...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ref={ref}
    className={cn(
      "relative flex w-full cursor-default select-none items-center gap-1.5 min-h-[32px] py-[5px] pe-1.5 ps-7 mx-1 rounded-md text-sm outline-none focus:bg-accent dark:focus:bg-neutral-800 focus:text-accent-foreground data-[disabled]:pointer-events-none data-[disabled]:opacity-50",
      className,
    )}
    {...props}
  >
