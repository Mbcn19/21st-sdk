...
export function ComponentCardSkeleton() {
  return (
    <li className="w-full component-card flex flex-col items-center justify-center p-5 animate-pulse">
      <div className="w-full aspect-[4/3] rounded-[12px] bg-muted/30" />
    </li>
  )
}
