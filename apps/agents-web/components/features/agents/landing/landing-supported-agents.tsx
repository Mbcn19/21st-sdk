...
const agents = [
  {
    ...
    by: "Anthropic",
    description:
      "The original coding agent. Deep reasoning, careful edits, and full codebase understanding.",
    logo: (
      <svg
        viewBox="0 0 24 24"
        className="h-8 w-8"
  ...
  },
  {
    ...
    by: "OpenAI",
    description:
      "OpenAI's cloud-native coding agent. Fast execution, parallel tasks, and broad model support.",
    logo: (
      <svg
        viewBox="0 0 24 24"
        className="h-8 w-8"
...
export function LandingSupportedAgents() {
  return (
    <section className="px-8 py-20 sm:py-28">
      <SectionHeader
        overline="Supported Agents"
        heading="One app, multiple agents."
        subtext="Switch between coding agents instantly. Use the right model for each task."
      />
        ...
        {agents.map((agent, index) => (
          ...
          >
            <div className="flex items-start gap-4">
              <div className="text-white/70 shrink-0">{agent.logo}</div>
              <div>
