...
export const TemplatesIcon = ({
  ...
  >
    <path d="M7 4H17" />
    <path d="M5 7.5H19" />
    <path d="M18.8687 11H5.13128C3.80864 11 2.85025 12.2609 3.20425 13.5353L4.59314 18.5353C4.83359 19.4009 5.62176 20 6.52017 20H17.4798C18.3782 20 19.1664 19.4009 19.4069 18.5353L20.7958 13.5353C21.1498 12.2609 20.1914 11 18.8687 11Z" />
  </svg>
)
...
export const AgentsIcon = ({
  ...
  >
    <g transform="scale(1.2) translate(-2.4, -2.4)">
      ...
      <path d="M21 12C21 12.5523 20.5523 13 20 13C19.4477 13 19 12.5523 19 12C19 11.4477 19.4477 11 20 11C20.5523 11 21 11.4477 21 12Z" />
      <path d="M13 4C13 4.55228 12.5523 5 12 5C11.4477 5 11 4.55228 11 4C11 3.44772 11.4477 3 12 3C12.5523 3 13 3.44772 13 4Z" />
      <path d="M13 20C13 20.5523 12.5523 21 12 21C11.4477 21 11 20.5523 11 20C11 19.4477 11.4477 19 12 19C12.5523 19 13 19.4477 13 20Z" />
      <path d="M13.5 8C13.5 8.82843 12.8284 9.5 12 9.5C11.1716 9.5 10.5 8.82843 10.5 8C10.5 7.17157 11.1716 6.5 12 6.5C12.8284 6.5 13.5 7.17157 13.5 8Z" />
...
export function MagicChatIcon({ className }: { className?: string }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
    ...
    >
      ...
      />
      <path
        d="M5 19.5001L10.7588 4.2805C11.307 2.8316 13.2233 2.52921 14.1911 3.7389L18 8.50007H14.2L19 19.5001"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinecap="square"
        strokeLinejoin="round"
      />
      <path
        d="M12.75 15.458C12.8305 15.5705 12.9285 15.6695 13.041 15.75C12.9288 15.8304 12.8304 15.9288 12.75 16.041C12.6695 15.9285 12.5705 15.8305 12.458 15.75C12.5707 15.6694 12.6694 15.5707 12.75 15.458Z"
        stroke="currentColor"
        strokeWidth="2"
      />
      <path
        d="M10 11.458C10.0805 11.5705 10.1785 11.6695 10.291 11.75C10.1788 11.8304 10.0804 11.9288 10 12.041C9.91946 11.9285 9.82053 11.8305 9.70801 11.75C9.82074 11.6694 9.91937 11.5707 10 11.458Z"
        stroke="currentColor"
        strokeWidth="2"
      />
    </svg>
...
export const BookmarkListIcon = (props: IconProps) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="24"
    height="24"
  ...
  >
    <g transform="scale(1.15) translate(-1.8, -1.8)">
      ...
      />
      <path
        d="M9.5 10.25L11 11.75L14.5 8.25"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinecap="round"
        strokeLinejoin="round"
...
export const BulletListIcon = (props: IconProps) => (
  ...
  >
    <g transform="scale(1.15) translate(-1.8, -1.8)">
      <path d="M10 6L20 6" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
      <circle cx="4.5" cy="6" r="1.5" fill="currentColor" />
      <path d="M10 12L20 12" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
      <circle cx="4.5" cy="12" r="1.5" fill="currentColor" />
      <path d="M10 18L20 18" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
...
export const OneCodeIcon = (props: IconProps) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="16"
    height="16"
