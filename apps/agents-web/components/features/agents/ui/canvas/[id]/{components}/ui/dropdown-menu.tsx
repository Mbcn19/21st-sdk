...
>(({ className, inset, children, ...props }, ref) => (
  <DropdownMenuPrimitive.SubTrigger
    ref={ref}
    className={cn(
      "flex cursor-default select-none items-center gap-1.5 min-h-[32px] py-[5px] px-1.5 mx-1 rounded-md text-sm outline-none focus:bg-accent dark:focus:bg-neutral-800 dark:hover:bg-neutral-800 hover:text-foreground data-[state=open]:bg-accent dark:data-[state=open]:bg-neutral-800 transition-colors [&_svg]:pointer-events-none [&_svg]:shrink-0",
      inset && "pl-8",
      className,
    )}
    {...props}
