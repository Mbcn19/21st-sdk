        ...
        {models.map((model) => {
          ...
          return (
            <div
              ...
              className={`flex items-center gap-2 px-2 py-1.5 rounded-md text-[12px] leading-4 cursor-pointer hover:bg-accent dark:hover:bg-neutral-800 ${isActive ? "bg-accent dark:bg-neutral-800" : ""}`}
            >
