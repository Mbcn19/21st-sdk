...
export const SOURCE_DETAIL = {
  ...
  // Agents sources
  AGENTS_PRICING_DIALOG: "agents_pricing_dialog",

  // Invite sources
  INVITE_DIALOG_OPENED: "invite_dialog_opened",
...
// Invite-specific tracking events
export const INVITE_EVENTS = {
  DIALOG_OPENED: "invite_dialog_opened",
  LINK_COPIED: "invite_link_copied",
  CODE_REGENERATED: "invite_code_regenerated",
  LANDING_VIEWED: "invite_landing_viewed",
  ACCEPTED: "invite_accepted",
  LIMIT_REACHED: "invite_limit_reached",
} as const
