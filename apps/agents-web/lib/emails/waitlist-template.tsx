...
export const WaitlistEmail = ({ userName }: WaitlistEmailProps) => {
    ...
    <EmailLayout preview={`Thank you for joining our waitlist${displayName}! Welcome to 21st.`}>
      ...
      <EmailCard>
        <EmailSection>
          ...
          <Text style={bodyText}>You're in.</Text>

          <Text style={bodyText}>
            21st is a design tool for <span style={highlight}>vibe crafting</span>: discover references, iterate visually, and ship work that feels like you.
          </Text>
          ...
          <Text style={bodyText}>
            ...
            <a href="https://x.com/21st_dev" style={twitterLink}>
              Twitter
            </a>{" "}
