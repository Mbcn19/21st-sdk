...
export const promptOptions: PromptOption[] = [
  // Alphabetical by label
  {
    ...
    action: "copy",
    icon: (
      <BoltLogoIcon className="min-h-[18px] min-w-[18px] max-h-[18px] max-w-[18px]" />
    ),
  },
  {
    type: "option",
    id: PROMPT_TYPES.CLAUDE_CODE,
    label: "Claude Code",
    description: "Optimized for Claude Code",
    action: "copy",
    icon: (
      <ClaudeCodeLogoIcon className="min-h-[18px] min-w-[18px] max-h-[18px] max-w-[18px]" />
    ),
  },
  {
    type: "option",
    ...
    action: "copy",
    icon: (
      <CursorIcon className="min-h-[18px] min-w-[18px] max-h-[18px] max-w-[18px]" />
    ),
  },
  {
    type: "option",
    ...
    action: "copy",
    icon: (
      <LovableLogoIcon className="min-h-[18px] min-w-[18px] max-h-[18px] max-w-[18px]" />
    ),
  },
  {
    type: "option",
    ...
    action: "copy",
    icon: (
      <ReplitIcon className="min-h-[22px] min-w-[22px] max-h-[22px] max-w-[22px]" />
    ),
  },
  {
    type: "option",
    ...
    action: "copy",
    icon: (
      <V0LogoIcon className="min-h-[18px] min-w-[18px] max-h-[18px] max-w-[18px]" />
    ),
  },
]
...
export const getComponentInstallPrompt = ({
  ...
  if (
    ...
    promptType === PROMPT_TYPES.CLAUDE_CODE
  ) {
    prompt +=
      endent`
